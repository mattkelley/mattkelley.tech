  ...
  render() {
    ...
    return (
      <section className="app-section">
        ...
        <p>
          This page was generated by commit <a href={githubUrl}>{buildSha}</a>. It was built {buildDate} by TravisCI{' '}
          <a href={buildUrl}>job #{buildNumber}</a> in about {buildDuration}. If for some reason you are interested, you
          can <a href={compareUrl}> compare changes</a> from the previous release.
        </p>
      </section>
    );
  }
